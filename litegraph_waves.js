 ...
 */
         ...
         * @param {String} name node name with namespace (p.e.: 'sum')
         * @param {Function} func
         ...
         * @method createNode
         * @param {String} type full name of the node class. p.e. "sin"
...
(function(global) {
    ...
    //LiteGraph.registerNodeType("time", Time);
    ...
    LiteGraph.registerNodeType("subgraph", Subgraph);
    ...
    LiteGraph.registerNodeType("input", GraphInput);
    ...
    LiteGraph.registerNodeType("output", GraphOutput);
    ...
    //LiteGraph.registerNodeType("const", ConstantNumber);
    ...
    //LiteGraph.registerNodeType("string", ConstantString);
    ...
    //LiteGraph.registerNodeType("data", ConstantData);
    ...
    //LiteGraph.registerNodeType("object_property", ObjectProperty);
    ...
    //LiteGraph.registerNodeType("object_keys", ObjectKeys);
    ...
    //LiteGraph.registerNodeType("merge_objects", MergeObjects );
    ...
    //LiteGraph.registerNodeType("variable", Variable);
    ...
    //LiteGraph.registerNodeType("download", DownloadData);
    ...
    //LiteGraph.registerNodeType("cast", Cast);
    ...
    LiteGraph.registerNodeType("console", Console);
    ...
    LiteGraph.registerNodeType("alert", Alert);
...
(function(global) {
    ...
    LiteGraph.registerNodeType("log", LogEvent);
    ...
    LiteGraph.registerNodeType("trigger", TriggerEvent);
    ...
    LiteGraph.registerNodeType("sequencer", Sequencer);
    ...
    LiteGraph.registerNodeType("filter", FilterEvent);
    ...
    LiteGraph.registerNodeType("counter", EventCounter);
    ...
    LiteGraph.registerNodeType("delay", DelayEvent);
    ...
    LiteGraph.registerNodeType("timer", TimerEvent);
    ...
    LiteGraph.registerNodeType("data_store", DataStore);
})(this);
...
(function(global) {
    ...
    LiteGraph.registerNodeType("button", WidgetButton);
    ...
    LiteGraph.registerNodeType("toggle", WidgetToggle);
    ...
    LiteGraph.registerNodeType("number", WidgetNumber);
    ...
    LiteGraph.registerNodeType("knob", WidgetKnob);
    ...
    LiteGraph.registerNodeType("internal_slider", WidgetSliderGUI);
    ...
    LiteGraph.registerNodeType("hslider", WidgetHSlider);
    ...
    LiteGraph.registerNodeType("progress", WidgetProgress);
    ...
    LiteGraph.registerNodeType("text", WidgetText);
    ...
    LiteGraph.registerNodeType("panel", WidgetPanel);
})(this);
...
(function(global) {
    ...
    LiteGraph.registerNodeType("gamepad", GamepadInput);
})(this);
...
(function(global) {
    ...
    LiteGraph.registerNodeType("converter", Converter);
    ...
    LiteGraph.registerNodeType("bypass", Bypass);
    ...
    LiteGraph.registerNodeType("to_number", ToNumber);
    ...
    LiteGraph.registerNodeType("range", MathRange);
    ...
    LiteGraph.registerNodeType("rand", MathRand);
    ...
    LiteGraph.registerNodeType("noise", MathNoise);
    ...
    LiteGraph.registerNodeType("spikes", MathSpikes);
    ...
    LiteGraph.registerNodeType("clamp", MathClamp);
    ...
    LiteGraph.registerNodeType("lerp", MathLerp);
    ...
    LiteGraph.registerNodeType("abs", MathAbs);
    ...
    LiteGraph.registerNodeType("floor", MathFloor);
    ...
    LiteGraph.registerNodeType("frac", MathFrac);
    ...
    LiteGraph.registerNodeType("smoothstep", MathSmoothStep);
    ...
    LiteGraph.registerNodeType("scale", MathScale);
	...
	LiteGraph.registerNodeType("gate", Gate);
    ...
    LiteGraph.registerNodeType("average", MathAverageFilter);
    ...
    LiteGraph.registerNodeType("tendTo", MathTendTo);
    ...
    LiteGraph.registerNodeType("operation", MathOperation);

    LiteGraph.registerSearchboxExtra("operation", "MAX", {
        properties: {OP:"max"},
        title: "MAX()"
    });

    LiteGraph.registerSearchboxExtra("operation", "MIN", {
        properties: {OP:"min"},
        title: "MIN()"
    });
    ...
    LiteGraph.registerNodeType("compare", MathCompare);

    LiteGraph.registerSearchboxExtra("compare", "==", {
        outputs: [["A==B", "boolean"]],
        title: "A==B"
    });
    LiteGraph.registerSearchboxExtra("compare", "!=", {
    ...
    LiteGraph.registerNodeType("condition", MathCondition);
    ...
    LiteGraph.registerNodeType("accumulate", MathAccumulate);
    ...
    LiteGraph.registerNodeType("trigonometry", MathTrigonometry);

    LiteGraph.registerSearchboxExtra("trigonometry", "SIN()", {
        outputs: [["sin", "number"]],
        title: "SIN()"
    });
    LiteGraph.registerSearchboxExtra("trigonometry", "COS()", {
        outputs: [["cos", "number"]],
        title: "COS()"
    });
    LiteGraph.registerSearchboxExtra("trigonometry", "TAN()", {
        outputs: [["tan", "number"]],
        title: "TAN()"
    });
    ...
    LiteGraph.registerNodeType("formula", MathFormula);
    ...
    LiteGraph.registerNodeType("vec2-to-xy", Math3DVec2ToXY);
    ...
    LiteGraph.registerNodeType("xy-to-vec2", Math3DXYToVec2);
    ...
    LiteGraph.registerNodeType("vec3-to-xyz", Math3DVec3ToXYZ);
    ...
    LiteGraph.registerNodeType("xyz-to-vec3", Math3DXYZToVec3);
    ...
    LiteGraph.registerNodeType("vec4-to-xyzw", Math3DVec4ToXYZW);
    ...
    LiteGraph.registerNodeType("xyzw-to-vec4", Math3DXYZWToVec4);
    ...
    if (global.glMatrix) {
        ...
        LiteGraph.registerNodeType("quaternion", Math3DQuaternion);
        ...
        LiteGraph.registerNodeType("rotation", Math3DRotation);
        ...
        LiteGraph.registerNodeType("rotate_vec3", Math3DRotateVec3);
        ...
        LiteGraph.registerNodeType("mult-quat", Math3DMultQuat);
        ...
        LiteGraph.registerNodeType("quat-slerp", Math3DQuatSlerp);
    } //glMatrix
})(this);
...
(function(global) {
    ...
    LiteGraph.registerNodeType("operation", Math3DOperation);
    ...
    LiteGraph.registerNodeType("vec3-scale", Math3DVec3Scale);
    ...
    LiteGraph.registerNodeType("vec3-length", Math3DVec3Length);
    ...
    LiteGraph.registerNodeType("vec3-normalize", Math3DVec3Normalize);
    ...
    LiteGraph.registerNodeType("vec3-lerp", Math3DVec3Lerp);
    ...
    LiteGraph.registerNodeType("vec3-dot", Math3DVec3Dot);
    ...
    if (global.glMatrix) {
        ...
        LiteGraph.registerNodeType("remap_range", Math3DRemapRange);
...
(function(global) {
    ...
    LiteGraph.wrapFunctionAsNode("toString", compare, ["*"], "String");
...
(function(global) {
    ...
    LiteGraph.registerNodeType("selector", Selector);
    ...
    LiteGraph.registerNodeType("sequence", Sequence);
})(this);
...
(function(global) {
    ...
    LiteGraph.registerNodeType("plot", GraphicsPlot);
    ...
    LiteGraph.registerNodeType("image", GraphicsImage);
	...
	*/
    ...
    LiteGraph.registerNodeType("palette", ColorPalette);
    ...
    LiteGraph.registerNodeType("frame", ImageFrame);
    ...
    LiteGraph.registerNodeType("imagefade", ImageFade);
    ...
    LiteGraph.registerNodeType("cropImage", ImageCrop);
    ...
    LiteGraph.registerNodeType("canvas", CanvasNode);
    ...
    LiteGraph.registerNodeType("drawImage", DrawImageNode);
    ...
    LiteGraph.registerNodeType("drawRectangle", DrawRectangleNode);
	...
	*/
    ...
    LiteGraph.registerNodeType("video", ImageVideo);
    ...
    LiteGraph.registerNodeType("webcam", ImageWebcam);
})(this);
...
(function(global) {
	...
	LiteGraph.registerNodeType( "points3D", LGraphPoints3D );
	...
	LiteGraph.registerNodeType( "toGeometry", LGraphToGeometry );
	...
	LiteGraph.registerNodeType( "eval", LGraphGeometryEval );
...
function LGraphGeometryDisplace() {
	...
	LiteGraph.registerNodeType( "displace", LGraphGeometryDisplace );
*/
	...
	LiteGraph.registerNodeType( "connectPoints", LGraphConnectPoints );
	...
	LiteGraph.registerNodeType( "render", LGraphRenderGeometry );
	...
	LiteGraph.registerNodeType( "render_points", LGraphRenderPoints );
	...
	LiteGraph.registerNodeType( "render_dof", LGraphRenderGeometryDOF );
...
(function(global) {
	...
	*/
    ...
    LiteGraph.registerNodeType("input", LGMIDIIn);
    ...
    LiteGraph.registerNodeType("output", LGMIDIOut);
    ...
    LiteGraph.registerNodeType("show", LGMIDIShow);
    ...
    LiteGraph.registerNodeType("filter", LGMIDIFilter);
    ...
    LiteGraph.registerNodeType("event", LGMIDIEvent);
    ...
    LiteGraph.registerNodeType("cc", LGMIDICC);
    ...
    LiteGraph.registerNodeType("generator", LGMIDIGenerator);
    ...
    LiteGraph.registerNodeType("transpose", LGMIDITranspose);
    ...
    LiteGraph.registerNodeType("quantize", LGMIDIQuantize);
    ...
    LiteGraph.registerNodeType("play", LGMIDIPlay);
    ...
    LiteGraph.registerNodeType("keys", LGMIDIKeys);
...
(function(global) {
    ...
    LiteGraph.registerNodeType("source", LGAudioSource);
    ...
    LiteGraph.registerNodeType("media_source", LGAudioMediaSource);
    ...
    LiteGraph.registerNodeType("analyser", LGAudioAnalyser);
    ...
    LiteGraph.registerNodeType("gain", LGAudioGain);
    ...
    LiteGraph.registerNodeType("convolver", LGAudioConvolver);
...
LiteGraph.registerNodeType("waveShaper", LGAudioWaveShaper);
*/
    ...
    LiteGraph.registerNodeType("mixer", LGAudioMixer);
    ...
    LiteGraph.registerNodeType("adsr", LGAudioADSR);
    ...
    LiteGraph.registerNodeType("delay", LGAudioDelay);
    ...
    LiteGraph.registerNodeType("biquadfilter", LGAudioBiquadFilter);
    ...
    LiteGraph.registerNodeType("oscillator", LGAudioOscillatorNode);
    ...
    LiteGraph.registerNodeType("visualization", LGAudioVisualization);
    ...
    LiteGraph.registerNodeType("signal", LGAudioBandSignal);
    ...
    LiteGraph.registerNodeType("script", LGAudioScript);
    ...
    LiteGraph.registerNodeType("destination", LGAudioDestination);
})(this);
...
(function(global) {
    ...
    LiteGraph.registerNodeType("websocket", LGWebSocket);
    ...
    LiteGraph.registerNodeType("sillyclient", LGSillyClient);
})(this);
